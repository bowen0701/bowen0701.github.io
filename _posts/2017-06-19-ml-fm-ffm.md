...
excerpt: "Introductory two useful machine learning models for the cases with lots of categorical feature interactions, and thus is popular in data science competitions."
date: 2017-06-19
mathjax: true
---
...
This post is to summarize FM & FFM, which are useful for the cases with lots of categorical feature interactions and thus is popular in data science competitions, especially for ad click through rate (CTR) prediction:
