...
Let $$p_B = Pr(D|E)$$ be the conditional probability of event, $$D$$, given the exposure group, B, and $$p_A = Pr(D|\barE)$$ the conditional probability of event, $$D$$, given the non-exposure group, A.
