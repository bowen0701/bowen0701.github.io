...
Then (1) $$U$$ is *orthonormal* matrix with
$$u_i^T u_j = 
\begin{cases} 
1, \text{if } i=j \\
0, \text{otherwise}
...
- *Sketch of proof:* $$u_i^T u_j = \frac{1}{n} \left( \frac{1}{\lambda_i} X v_i \right)^T \left( \frac{1}{\lambda_j} X v_j \right) = \frac{1}{n} \frac{1}{\lambda_i \lambda_j} v_i^T X^T X v_j = \frac{1}{\lambda_i \lambda_j} v_i^T d_i v_j = \frac{\lambda_i}{\lambda_j} v_i^T v_j$$. The first result follows. Further, we can obtain the second result similarly.
