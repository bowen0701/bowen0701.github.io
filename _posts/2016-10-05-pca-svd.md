...
- [PCA and SVD](#pca-and-svd)
  * [How Many Principal Components We Shall Use?](#how-many-principal-components-we-shall-use)
...
<img src="/images/pca_snr.png" alt="Drawing" style="width: 250px;" class="center"/>
...
*Alternative proof:* We can interpret PCA as finding a unit vector $$u$$, with $$\|u\| = 1$$, which maximizes variance of the projection of all example $$x_i$$ onto $$u$$,
...
since $$x_i^T x_i = \|x_i\|^2$$. Finally, the projection of one example $$x_i$$ onto $$u$$ is the distance $$x_i^T u$$ from the origin.
...
### How Many Principal Components We Shall Use?
- Total variances: $$\sum_{j=1}^p \lambda_j^2$$.
- *Scree plot:* Choose the number of principal component by *elbow method.*

<div style="text-align: center"><img src="/images/pca_scree_plot.png" alt="Drawing" style="width: 300px;" class="center"/></div>
