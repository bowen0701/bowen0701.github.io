...
<img src="/images/polynomial_eqt.png" alt="Drawing" style="width: 600px;"/>
</div>
...
<div style="text-align:center">
<img src="/images/fm_eqt.png" alt="Drawing" style="width: 600px;"/>
</div>
...
<div style="text-align:center">
<img src="/images/fm_kernel_trick.png" alt="Drawing" style="width: 600px;"/>
</div>
...
<div style="text-align:center">
<img src="/images/ffm_eqt.png" alt="Drawing" style="width: 600px;"/>
</div>
...
- For 2nd-order polynomial weights, 
  * FFM: $nfk$ >> FM: $nk$
- The complexity of FFM is about $O(kn^2)$.
  * of course _larger than that of FM_, that's why FFM would perform better than FM. 
- General model complexity comparison:
  * $\bar n$: average “effected” feature numbers; that is, average non-zero features per instance.

<div style="text-align:center">
<img src="/images/ffm_complexity_compare.png" alt="Drawing" style="width: 600px;"/>
</div>
